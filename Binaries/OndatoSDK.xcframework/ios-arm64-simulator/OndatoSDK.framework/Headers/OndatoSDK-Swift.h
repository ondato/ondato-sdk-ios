...
@class UIImage;
SWIFT_CLASS_NAMED("OndatoDocumentImages")
@interface OndatoDocumentImages : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setSelectionCardIcons:(NSDictionary<NSNumber *, UIImage *> * _Nonnull)icons;
@end
...
@property (nonatomic) BOOL isDemoApplication;
@property (nonatomic) BOOL showComplianceTextDocSelect;
@property (nonatomic) BOOL enableAgreeButtonAfterScrolling;
@property (nonatomic) double termsAgreementButtonTimeout;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, OndatoNFCCaptureComponent)
SWIFT_ENUM_FWD_DECL(NSInteger, OndatoServiceError)
...
- (void)flowDidFailWithIdentificationId:(NSString * _Nullable)identificationId error:(enum OndatoServiceError)error;
@end
...
@property (nonatomic, strong) OndatoDocumentImages * _Nonnull documentImages;
- (void)setDocumentCaptureInstructions:(NSDictionary<NSNumber *, NSDictionary<NSNumber *, UIImage *> *> * _Nonnull)instructions;
- (void)setAdditionalDocumentCaptureInstructions:(NSDictionary<NSNumber *, UIImage *> * _Nonnull)instructions;
- (void)setFaceCaptureInstructions:(NSDictionary<NSNumber *, UIImage *> * _Nonnull)instructions;
- (void)setNfcCaptureInstructions:(NSDictionary<NSNumber *, NSDictionary<NSNumber *, UIImage *> *> * _Nonnull)instructions;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS_NAMED("OndatoLanguageUtils")
@interface OndatoLanguageUtils : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OndatoLanguageUtils * _Nonnull shared;)
+ (OndatoLanguageUtils * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)languageToString:(NSInteger)language SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, OndatoSupportedLanguage)
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setLangauge:(enum OndatoSupportedLanguage)language;
...
- (void)setLocalizationBundle:(OndatoLocalizationBundle * _Nonnull)bundle languageCode:(NSString * _Nonnull)languageCode;
- (void)setLocalizationWithTable:(NSDictionary<NSString *, NSString *> * _Nonnull)table for:(enum OndatoSupportedLanguage)language;
- (void)setLocalizationWithTable:(NSDictionary<NSString *, NSString *> * _Nonnull)table languageCode:(NSString * _Nonnull)languageCode;
@end
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)nameLogFileWithNewFileName:(NSString * _Nonnull)newFileName;
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, OndatoServiceError, "OndatoServiceError", open) {
  OndatoServiceErrorBadFlowSetup = 0,
  OndatoServiceErrorConsentDeclined = 1,
  OndatoServiceErrorFailureExit = 2,
  OndatoServiceErrorInvalidID = 3,
  OndatoServiceErrorUnauthorized = 4,
  OndatoServiceErrorInternalServerError = 5,
  OndatoServiceErrorAborted = 6,
  OndatoServiceErrorNfcNotSupported = 7,
  OndatoServiceErrorRecorderFailure = 8,
  OndatoServiceErrorTooManyAttempts = 9,
  OndatoServiceErrorNoAvailableDocumentTypes = 10,
  OndatoServiceErrorGeneric = 11,
};
...
typedef SWIFT_ENUM_NAMED(NSInteger, OndatoSupportedLanguage, "OndatoSupportedLanguage", open) {
  ...
  OndatoSupportedLanguageCN = 2,
  OndatoSupportedLanguageCS = 3,
  OndatoSupportedLanguageDE = 4,
  OndatoSupportedLanguageDK = 5,
  OndatoSupportedLanguageEN = 6,
  OndatoSupportedLanguageES = 7,
  OndatoSupportedLanguageET = 8,
  OndatoSupportedLanguageFI = 9,
  OndatoSupportedLanguageFR = 10,
  OndatoSupportedLanguageHU = 11,
  OndatoSupportedLanguageEL = 12,
  OndatoSupportedLanguageIT = 13,
  OndatoSupportedLanguageKR = 14,
  OndatoSupportedLanguageLT = 15,
  OndatoSupportedLanguageLV = 16,
  OndatoSupportedLanguageNL = 17,
  OndatoSupportedLanguagePL = 18,
  OndatoSupportedLanguagePT = 19,
  OndatoSupportedLanguageRO = 20,
  OndatoSupportedLanguageRU = 21,
  OndatoSupportedLanguageSK = 22,
  OndatoSupportedLanguageSQ = 23,
  OndatoSupportedLanguageSV = 24,
  OndatoSupportedLanguageUA = 25,
  OndatoSupportedLanguageTH = 26,
  OndatoSupportedLanguageVI = 27,
};
